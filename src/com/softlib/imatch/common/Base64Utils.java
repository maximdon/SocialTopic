...
public class Base64Utils {
	...
	public static byte[] encode(byte[] b) throws Exception {
     ...
     public static void main(String[] args) throws Exception {
         File file = new File("C:/Temp/SalesforceContent.org/069P0000000FFSLIA4_D.pdf");
         String test = FileUtils.getContents(file);
         
         byte res[] = Base64Utils.encode(test.getBytes());
         char[] base64chars = (new String(res)).toCharArray();

		 FileWriter fstream = new FileWriter("C:/Temp/SalesforceContent.org/069P0000000FFSLIA4_D_base64_1.txt");
		 BufferedWriter out = new BufferedWriter(fstream);
		 out.write(base64chars);
		 out.close();
	 }
